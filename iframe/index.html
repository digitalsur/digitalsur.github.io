...
<link id="maintheme" href="https://radioplayer.link/iframe/assets/css/html5-tranparent.css" rel="stylesheet" type="text/css">
<link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500" rel="stylesheet" type="text/css">
 
<link rel="shortcut icon" href="favicon.ico">
<link rel="icon" type="image/png" sizes="192x192" href="https://radioplayer.link/iframe/assets/img/favicon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="https://radioplayer.link/iframe/assets/img/favicon-96x96.png">
<link rel="icon" type="image/png" sizes="96x96" href="https://radioplayer.link/iframe/assets/img/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="https://radioplayer.link/iframe/assets/img/favicon-16x16.png">
<script type="text/javascript" src="https://radioplayer.link/iframe/assets/js/jquery-1.11.2.min.js"></script>
<script type="text/javascript" src="https://radioplayer.link/iframe/assets/js/jquery.jplayer.min.js"></script>
...
<div class="main-container" style="margin: middle !important;">
  <div class="stats main" style="text-align: middle !important;">
    <div class="artist-image">
      <div><a id="promo"><img id="imagine" width="120" height="120" src="https://radioplayer.link/iframe/assets/img/radiologo.gif"></a></div>
...
<div class="volume-control">
  ...
  <div class="volume-slider">
    ...
    <div class="player-status"><font color="">En Vivo <span class="jp-current-time" role="timer">00:00</font></span></div>
  </div>
</div>
<div class="playlists">
  <span>Listen in your favourite player</span>
  <a tabindex="1" target="_blank" href="playlist.php?stream=&title=&name=Listen.pls" title="Winamp"><img width="32" height="32" src="https://radioplayer.link/iframe/assets/img/player-winamp-icon.svg"></a>
  <a tabindex="1" target="_blank" href="playlist.php?stream=&title=&name=Listen.asx" title="Windows Media Player"><img width="32" height="32" src="https://radioplayer.link/iframe/assets/img/player-wmp-icon.svg"></a>
  <a tabindex="1" target="_blank" href="playlist.php?stream=&title=&name=Listen.m3u" title="QuickTime"><img width="32" height="32" src="https://radioplayer.link/iframe/assets/img/player-quicktime-icon.svg"></a>
  <a tabindex="1" target="_blank" href="playlist.php?stream=&title=&name=Listen.m3u" title="VLC Player"><img width="32" height="32" src="https://radioplayer.link/iframe/assets/img/player-vlc-icon.svg"></a>
</div>
<small style="bottom: 8px;font-size: 8px;position: fixed;right: 8px;text-shadow: 0px 0px 4px rgba(0, 0, 0, 1);z-index: 1004;"><b><a style="color:#fff;text-decoration: none;" target="_blank" href="https://magicstreams.services" title="Sistemas Sureños">Sistemas Sureños</a></b></small>
</div>
</body>
</html>
